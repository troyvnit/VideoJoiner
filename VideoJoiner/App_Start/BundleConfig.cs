    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/angulr-js")
                ...
                ).IncludeDirectory("~/Scripts/VideoJoiner/Controllers", "*.js")
                .IncludeDirectory("~/Scripts/VideoJoiner/Services", "*.js")
                .IncludeDirectory("~/Scripts/VideoJoiner/Factories", "*.js")
                .Include("~/Scripts/VideoJoiner/app.js")
                );
